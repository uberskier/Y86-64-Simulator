class DecodeStage: public Stage
{
   private: 
      ...
      uint64_t controlFwdA(uint64_t srcA, M * mreg, W * wreg, uint64_t e_dstE, uint64_t e_valE);
      uint64_t controlFwdB(uint64_t srcB, M * mreg, W * wreg, uint64_t e_dstE, uint64_t e_valE);
   public:
